...
#define PID_OUTPUT_XKF ((double)0)
                       
#define PID_OUTPUT_YKP ((double)10/16)
#define PID_OUTPUT_YKI ((double)5/16)
#define PID_OUTPUT_YKD ((double)1/16)
#define PID_OUTPUT_YKF ((double)0)
                       
#define PID_DEPTH_KP ((double)10/16)
#define PID_DEPTH_KI ((double)5/16)
#define PID_DEPTH_KD ((double)1/16)
#define PID_DEPTH_KF ((double)0)
                     
#define PID_ANGLE_KP ((double)10/16)
#define PID_ANGLE_KI ((double)5/16)
#define PID_ANGLE_KD ((double)1/16)
#define PID_ANGLE_KF ((double)0)
                     
#define DISP_XY_RATIO ((double)0.8)
#define VERTICAL_COMBINER_RATIO ((double)0.5)
#define HORIZONTAL_COMBINER_RATIO ((double)0.5)
